#
#  Be sure to run `pod spec lint DLDialogBox.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   DLDialogBox allows you to easily create dialog boxes with
                   great flexibility in customizations.
                   DESC
  ...
  # s.authors      = { "Draco Li" => "draco@dracoli.com", "other author" => "email@address.com" }
  # s.author       = 'Draco Li', 'other author'
  ...
  # s.resource  = "icon.png"
  s.ios.resource_bundle = { 'DLDialogBox' => 'DLDialogBox/PresetResources/*.{png,plist,fnt}' }
