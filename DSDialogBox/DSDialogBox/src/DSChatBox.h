...
typedef enum {
  kPortraitPositionLeft = 0,
  kPortraitPositionRight
} PortraitPosition;
 ...
 */
@property (nonatomic, copy) NSString *portaitFrameName;
@property (nonatomic) BOOL showPortrait;
@property (nonatomic) PortraitPosition portraitPosition;
